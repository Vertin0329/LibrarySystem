...
namespace {
struct qt_meta_tag_ZN12filterDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto filterDialog::qt_create_metaobjectdata<qt_meta_tag_ZN12filterDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<filterDialog, qt_meta_tag_ZN12filterDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject filterDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12filterDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12filterDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12filterDialogE_t>.metaTypes,
    nullptr
} };
...
void *filterDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12filterDialogE_t>.strings))
