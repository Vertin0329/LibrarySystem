...
template <> constexpr inline auto LoginWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "LoginWindow",
        "on_pushButton_Forgotpw_clicked",
        "",
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_pushButton_Forgotpw_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushButton_Login_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_lineEdit_Password_returnPressed'
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushButton_Forgotpw_clicked(); break;
        case 1: _t->on_pushButton_Login_clicked(); break;
        case 2: _t->on_lineEdit_Password_returnPressed(); break;
